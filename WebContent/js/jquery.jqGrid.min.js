...
$.fn.jqFilter = function( arg ) {
	...
	var p = $.extend(true,{
		...
		sopt : null,
		ops : [
			{"name": "eq", "description": "equals to", "operator":"="},
			//{"name": "ne", "description": "not equal", "operator":"<>"},
			{"name": "lt", "description": "less than", "operator":"<"},
			//{"name": "le", "description": "less or equal","operator":"<="},
			{"name": "gt", "description": "greater than", "operator":">"},
		...
		numopts : ['eq', 'lt', 'gt', 'nu', 'nn', 'in'],
		stropts : ['eq', 'lt', 'gt', 'bw', 'ew', 'cn', 'nu', 'nn', 'in'],
